...
from mmdet3d.evaluation.functional import EvalPanoptic
...
class PanopticSegMetric(SegMetric):
    ...
    def compute_metrics(self, results: list) -> Dict[str, float]:
        ...
        panoptic_seg_eval = EvalPanoptic(classes, things_classes,
                                         stuff_classes, self.min_points,
                                         self.offset, label2cat,
                                         [ignore_index], logger)
